        ...
        <div>
          ...
          >
            ...
            <div>
              <div>
                <a
                  className="flex items-center justify-center gap-1 bg-violet-700 hover:bg-violet-800 transition-colors duration-300 ease-in-out w-[150px] mb-10 py-2 font-semibold text-center rounded-lg"
                ...
                <div className="flex mb-10">
                  <a
                    className="flex items-center justify-center gap-1 bg-violet-700 hover:bg-violet-800 transition-colors duration-300 ease-in-out w-[150px] py-2 font-semibold text-center rounded-lg mr-3"
                  ...
                  <a
                    className="flex items-center justify-center gap-1 bg-violet-700 hover:bg-violet-800 transition-colors duration-300 ease-in-out w-[150px] py-2 font-semibold text-center rounded-lg"
              ...
              <div className="flex flex-col items-start mb-10">
                <p className="bg-violet-700 font-semibold text-gray-200 py-1 px-2 rounded-lg mb-3">
                  Feautures
                </p>
